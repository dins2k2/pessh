...
#---- Added for https://github.com/dins2k2/pessh ------------------------------------------------------

[ "$(basename "$0")" = "pessh" ] && ENCPASS_HOME_DIR="$(dirname $(readlink -f $0))"/security/.encpass
[ "$(basename "$0")" = "encpass.sh" ] && ENCPASS_HOME_DIR="$(dirname $(readlink -f $0))"/.encpass
